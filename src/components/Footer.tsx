...
const Footer = () => {
  ...
  return (
    <footer className="construction-gradient text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="font-bold text-xl">Prestige Construction</h3>
                <p className="text-secondary text-sm">& Builders</p>
              </div>
            </div>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold text-lg mb-4 text-secondary">{t('quickLinks')}</h4>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="font-semibold text-lg mb-4 text-secondary">{t('contact')}</h4>
            <div className="space-y-2 text-gray-300">
              <p>📍 Kathmandu, Nepal</p>
              <p>📞 +977-1234567890</p>
              <p>✉️ info@prestigeconstruction.com</p>
            </div>
          </div>
        </div>

        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 Prestige Construction & Builders. {t('allRightsReserved')}</p>
        </div>
      </div>
    </footer>
  );
